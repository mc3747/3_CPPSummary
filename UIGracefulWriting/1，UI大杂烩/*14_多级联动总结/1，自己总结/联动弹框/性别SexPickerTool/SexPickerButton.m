...
@interface SexPickerButton()
@property (nonatomic, strong) UIView *bgView;
@property (nonatomic, strong) SexPickerTool *pickTool;
@end
@implementation SexPickerButton
