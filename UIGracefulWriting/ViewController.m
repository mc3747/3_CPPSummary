...
- (void)test20 {
    ...
    vc.vcNameArray = @[@"ShadeEffectVC",@"MoneyAnimationVC",@"CQFilterViewController",@"CQJigsawViewController",@"DimImageViewController",@"Switch1_ViewController",@"Switch2_ViewController",@"IconFontViewController",@"ScreenShotVC",@"RichTextVC",@"MemoTableViewController",@"DemosViewController",@"DropDownViewController",@"YZDropViewController",@"Switch3_ViewController",@"AlertViewController",@"AlertTableViewController",@"ActionSheetTableViewController",@"FatherAndSonVC"];
    
    vc.subtitleArray = @[@"1，渐变效果",@"2，金额跳动效果",@"3，模态弹窗",@"4，比例拼图",@"5，模糊效果",@"6，横向切换1",@"7，横向切换2",@"8，IconFont的使用",@"9，截屏展示",@"10，富文本总结",@"11，便签效果",@"12，IGListKit的Demo",@"13，美团下拉二级菜单",@"14，袁崢二级菜单",@"15，SGPagingView横向切换",@"16，系统alert和sheet",@"17，第三方alert",@"18，第三方sheet",@"19，父子控制器"];
    [self.navigationController pushViewController:vc animated:YES];
}
